...
export default function Home() {
  ...
  <div className="md:order-2">
    ...
    <p className='text-3xl '>Whether you're a passionate entrepreneur looking to sell your thriving business or a savvy investor seeking the next big opportunity, BizLink is the bridge that brings your goals to reality.</p>
  </div>
  <div className="md:order-1 w-full md:w-1/2 flex justify-center items-center">
    <Image src={div1} alt="description of image" className=" object-cover" />
          ...
          <div className=" text-center mt-5">
            <h2 className='text-5xl'>Key Benefits:</h2>
            <ul>
              <li>
          ...
          <div className="text-center mt-5">
            ...
            <p>Ready to embark on your business journey? </p>
            <p>Join BizLink now and take the first step towards a successful business transaction</p>
